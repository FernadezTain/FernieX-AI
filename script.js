const neuralNetworks = [
    /*
    {
        ...
        badge: "premium",
        description: "Быстрая и профессиональная нейросеть, ориентированная на дружелюбное и креативное общение.",
        features: [
            "Оптимизирована для низкой задержки и высокой скорости отклика",
            "Поддержка длинного контекста (десятки тысяч токенов)",
            "Улучшенная логика и понимание сложных запросов",
            "Подходит для чатов, ассистентов и real-time сценариев",
            "Поддерживает общение на темы 18+ в дружеском стиле с возможностью использования нецензурной лексики и резких выражений"
        ]
    },
    {
        id: "Grok",
